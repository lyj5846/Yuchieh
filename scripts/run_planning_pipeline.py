...
def build_plan(config: dict, data_latest_date: str) -> dict:
    ...
    candidates = [
        {
            "id": "drawdown_side_label_main_model_training_plan",
            ...
            "why_now": "The drawdown side-label review showed that many valid +3% successes first touched -3%; the previous hard-risk target was too strict for the user's trading question. The next step is retraining the same main model with corrected labels, not a new model branch.",
            "target_label": [
                "target_success_10d_plus3_touch",
                "drawdown_minus3_side_label",
                "clean_success_label",
            ...
            "feature_changes": [
                ...
                "Use future prices only in the label layer to identify +3% touch success and drawdown side labels.",
            ],
            "model_changes": [
                ...
                "Keep risk_adjusted_10d_success only as a hard-risk comparison field.",
            ...
            "risk_notes": [
                "The primary success rate will return to the +3% touch target; risk quality must be judged through side labels, not by turning drawdown into automatic failure.",
    ...
    return {
        ...
        "problem_statement": "The hard -3% risk-adjusted target failed because it rejected many valid +3% rebound successes. The next step is feature-screened retraining of the single deep-learning main model with +3% touch as primary success and -3% drawdown as a risk side label.",
        "recommended_experiment_id": "drawdown_side_label_main_model_training_plan",
