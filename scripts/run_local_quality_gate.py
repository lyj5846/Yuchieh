...
def main() -> None:
    ...
    for script in [
        ...
        "scripts/run_raw_rank_bucket_backtest.py",
        "scripts/check_raw_rank_bucket_backtest.py",
        "scripts/run_theme_rotation_feature_review.py",
        "scripts/check_theme_rotation_feature_review.py",
